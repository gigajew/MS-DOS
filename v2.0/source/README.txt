...
Here is what you need to do to MSDOS 2.0 to create a shippable product:
...
3.  Utilities.  FORMAT must be configured for each specific system.
    ...
    is conditioned out for the IBM PC timer interrupt.
...
1.  In implementing MSDOS on a new machine, it is highly recommended
    ...
    system calls and WILL NOT run under MSDOS 1.25.
